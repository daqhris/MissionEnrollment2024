...
async function fixture() {
  ...
  const testRegistrar = await hre.viem.deployContract("TestRegistrar", [ensRegistry.address, zeroHash]);
...
describe("TestRegistrar", () => {
  it("registers names", async () => {
    ...
    await expect(ensRegistry.read.owner([zeroHash])).resolves.toEqualAddress(testRegistrar.address);
