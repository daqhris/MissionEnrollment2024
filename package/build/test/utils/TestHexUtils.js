...
describe("HexUtils", () => {
    ...
    it("converts a hex string to bytes", async () => {
      ...
      await expect(
        hexUtils.read.hexToBytes([
          stringToHex("5cee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da"),
          0n,
          64n,
        ]),
      ).resolves.toMatchObject(["0x5cee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da", true]);
    });
    it("handles short strings", async () => {
      const { hexUtils } = await loadFixture(fixture);
      await expect(hexUtils.read.hexToBytes([stringToHex("5cee"), 0n, 4n])).resolves.toMatchObject(["0x5cee", true]);
    });
    it("handles long strings", async () => {
      const { hexUtils } = await loadFixture(fixture);
      await expect(
        hexUtils.read.hexToBytes([
          stringToHex("5cee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da010203"),
          0n,
          70n,
        ]),
      ).resolves.toMatchObject(["0x5cee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da010203", true]);
    });
  });
  describe("hexStringToBytes32()", () => {
    ...
    it("uses the correct index to read from", async () => {
      ...
      await expect(
        hexUtils.read.hexStringToBytes32([
          stringToHex("zzzzz0x5cee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da"),
          7n,
          71n,
        ]),
      ).resolves.toMatchObject(["0x5cee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da", true]);
    ...
    it("correctly parses all the hex characters", async () => {
      const { hexUtils } = await loadFixture(fixture);
      await expect(
        hexUtils.read.hexStringToBytes32([stringToHex("0123456789abcdefABCDEF0123456789abcdefABCD"), 0n, 40n]),
      ).resolves.toMatchObject(["0x0000000000000000000000000123456789abcdefabcdef0123456789abcdefab", true]);
    });
    it("returns invalid when the string contains non-hex characters", async () => {
      const { hexUtils } = await loadFixture(fixture);
      await expect(
        hexUtils.read.hexStringToBytes32([
          stringToHex("zcee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da"),
          0n,
          64n,
        ]),
  ...
  describe("hexToAddress()", async () => {
    it("converts a hex string to an address", async () => {
      ...
      ).resolves.toMatchObject(["0x5ceE339e13375638553bdF5a6e36BA80fB9f6a4F", true]);
    });
  ...
  describe("special cases for hexStringToBytes32()", () => {
    ...
    it("exceed length", async () => {
      const { hexUtils } = await loadFixture(fixture);
      await expect(hexUtils)
        .read("hexStringToBytes32", [stringToHex(hex32Bytes + "1234"), 0n, 64n + 4n])
        .toBeRevertedWithoutReason();
    });
  });
});
