...
import { CAN_DO_EVERYTHING, expectOwnerOf, deployNameWrapperWithUtils as fixture, zeroAccount, } from '../fixtures/utils.js';
export const getApprovedTests = () => {
    describe('getApproved()', () => {
        ...
        it('Returns returns zero address when ownerOf() is zero', async () => {
            ...
            await expect(nameWrapper.read.getApproved([toNameId('unminted.eth')])).resolves.toEqualAddress(zeroAddress);
        });
