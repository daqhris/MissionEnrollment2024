...
import { CANNOT_SET_TTL, CANNOT_UNWRAP, expectOwnerOf, deployNameWrapperWithUtils as fixture, } from '../fixtures/utils.js';
export const setTTLTests = () => describe('setTTL', () => {
    const label = 'setttl';
    ...
    it('Performs the appropriate function on the ENS registry.', async () => {
        ...
        await nameWrapper.write.setTTL([namehash(name), 100n]);
        await expect(ensRegistry.read.ttl([namehash(name)])).resolves.toEqual(100n);
    });
