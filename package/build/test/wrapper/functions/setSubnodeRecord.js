...
import { CANNOT_CREATE_SUBDOMAIN, CANNOT_TRANSFER, CANNOT_UNWRAP, CAN_DO_EVERYTHING, GRACE_PERIOD, IS_DOT_ETH, MAX_EXPIRY, PARENT_CANNOT_CONTROL, expectOwnerOf, deployNameWrapperWithUtils as fixture, zeroAccount, } from '../fixtures/utils.js';
export const setSubnodeRecordTests = () => describe('setSubnodeRecord()', () => {
    ...
    it('Can be called by the owner of a name', async () => {
        const { ensRegistry, nameWrapper, actions, accounts, resolverAddress } = await loadFixture(setSubnodeRecordFixture);
