...
import { CANNOT_BURN_FUSES, CANNOT_CREATE_SUBDOMAIN, CANNOT_SET_RESOLVER, CANNOT_SET_TTL, CANNOT_TRANSFER, CANNOT_UNWRAP, CAN_DO_EVERYTHING, GRACE_PERIOD, IS_DOT_ETH, MAX_EXPIRY, PARENT_CANNOT_CONTROL, expectOwnerOf, deployNameWrapperWithUtils as fixture, } from '../fixtures/utils.js';
export const setFusesTests = () => {
    describe('setFuses()', () => {
        ...
        it('Logically ORs passed in fuses with already-burned fuses.', async () => {
            ...
            const [, fuses] = await nameWrapper.read.getData([toNameId(name)]);
            expect(fuses).toEqual(CANNOT_UNWRAP |
