...
import { CANNOT_UNWRAP, GRACE_PERIOD, PARENT_CANNOT_CONTROL, expectOwnerOf, deployNameWrapperWithUtils as fixture, zeroAccount, } from '../fixtures/utils.js';
export const isWrappedTests = () => {
    describe('isWrapped(bytes32 node)', () => {
        ...
        it('identifies an unregistered .eth name as unwrapped', async () => {
            const { nameWrapper } = await loadFixture(isWrappedFixture);
            await expect(nameWrapper.read.isWrapped([
