...
import { CANNOT_SET_RESOLVER, CANNOT_UNWRAP, CAN_DO_EVERYTHING, GRACE_PERIOD, IS_DOT_ETH, PARENT_CANNOT_CONTROL, expectOwnerOf, deployNameWrapperWithUtils as fixture, } from '../fixtures/utils.js';
    ...
    describe('registerAndWrapETH2LD()', () => {
        ...
        it('emits Wrap event', async () => {
            ...
            await expect(nameWrapper)
                ...
                .withArgs(namehash(name), dnsEncodeName(name), accounts[0].address, PARENT_CANNOT_CONTROL | IS_DOT_ETH, expiry + GRACE_PERIOD);
        });
