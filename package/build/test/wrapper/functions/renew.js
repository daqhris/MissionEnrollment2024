...
import { CANNOT_SET_RESOLVER, CANNOT_UNWRAP, CAN_DO_EVERYTHING, GRACE_PERIOD, IS_DOT_ETH, PARENT_CANNOT_CONTROL, deployNameWrapperWithUtils as fixture, } from '../fixtures/utils.js';
export const renewTests = () => {
    describe('renew', () => {
        ...
        it('Renewing name less than required to unexpire it still has original owner/fuses', async () => {
            ...
            expect(fusesAfter).toEqual(CANNOT_UNWRAP |
                CANNOT_SET_RESOLVER |
                IS_DOT_ETH |
