...
const func = async function (hre) {
  ...
  const reverseRegistrarDeployment = await viem.deploy("ReverseRegistrar", [registry.address]);
  ...
  const setReverseOwnerHash = await root.write.setSubnodeOwner([labelhash("reverse"), owner.address], {
