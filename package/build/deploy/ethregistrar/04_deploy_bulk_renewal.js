...
const func = async function (hre) {
  ...
  const bulkRenewal = await viem.deploy("StaticBulkRenewal", [controller.address]);
  ...
  console.log(`Setting BulkRenewal interface ID ${interfaceId} on .eth resolver (tx: ${setInterfaceHash})...`);
