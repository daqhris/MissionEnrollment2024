...
export interface DummyAlgorithm$Type {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<DummyAlgorithm$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/dnssec-oracle/algorithms/DummyAlgorithm.sol:DummyAlgorithm",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<DummyAlgorithm$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<DummyAlgorithm$Type["abi"]>;
